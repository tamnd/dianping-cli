...
Most of these come down to network reality or how dianping serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dianping rate-limits like any public site. dp already paces
...
Where a surface is gated, dp reads a cookie or token you supply
...
`dp`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dp actually did
